...
One of the tasks that R learners tend to find the hardest is loading their data. In this video, I show you the two ways we will be mainly using in this unit to load our data. All the data we will be working with is in *rectangular* format - in other words, data with rows and columns, and with one observation per cell. I will show you how to laod data that's sitting on your own machine, and how to load data that's sitting on a webpage.
...
You can also view and download the slides in a range of formats by clicking on the image below. If you don't have a Google account, you can download the slides in .pdf format by [clicking here](../slides/loading_data.pdf).

&nbsp;&nbsp;

<center>

[![Link to loading data slides](../images/getting_started.png){width=75%}](https://docs.google.com/presentation/d/19Y70sxKZH0Wp1Lm-0FMktiHjfAHBvHJHSfdxpPQuIgA/edit?usp=sharing
)
